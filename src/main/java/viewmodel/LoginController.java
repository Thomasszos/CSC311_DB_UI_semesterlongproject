...
public class LoginController {
    ...
    public void initialize() {
        ...
        if(UserSession.loadFromPreferences()!=null){
            usernameTextField.setText(UserSession.loadFromPreferences().getUserName());
            passwordField.setText(UserSession.loadFromPreferences().getPassword());
        }
    ...
    public void login(ActionEvent actionEvent) {
        ...
        if(myDB.login(myUsername, myPassword)) {
            try {
